...
export default function HomePage() {
  ...
  return (
    <>
            ...
            <div>
              ...
              <ul className="space-y-3 text-neutral-600 font-body text-sm">
                <li className="flex items-start space-x-2">
                  ...
                  <span>sunita4dsinetiles@gmail.com</span>
                </li>
                <li className="flex items-start space-x-2">
                  <svg className="w-5 h-5 text-neutral-600 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <span>+91 7008049913</span>
                </li>
                <li className="flex items-start space-x-2">
                  <svg className="w-5 h-5 text-neutral-600 shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <span>Baripada, Odisha, India</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <a
        href="https://wa.me/917008049913?text=Hi,%20I'd%20like%20to%20know%20more%20about%20your%20services"
        target="_blank"
      ...
      >
        <div className="relative">
          ...
          {/* Main button */}
          <div className="relative w-16 h-16 bg-[#25D366] rounded-full shadow-lg flex items-center justify-center transform transition-all duration-300 hover:scale-110 hover:shadow-2xl">
            {/* WhatsApp Icon */}
            <svg
          ...
          {/* Tooltip */}
          <div className="absolute right-full mr-3 top-1/2 -translate-y-1/2 bg-neutral-900 text-white px-4 py-2 rounded-lg text-sm font-body whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
            Chat with us on WhatsApp
            <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 rotate-45 w-2 h-2 bg-neutral-900" />
          </div>
        </div>
      </a>
    </>
